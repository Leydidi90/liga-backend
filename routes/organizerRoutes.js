...
router.get('/:slug/representative/dashboard', organizerController.getRepresentativeDashboard);
router.post('/:slug/representative/inscripciones/:inscripcionId/jugadores', organizerController.addPlayersToEnrollment);
...
router.get('/:slug/canchas', organizerController.getCanchas);
router.post('/:slug/canchas', organizerController.addCancha);
router.delete('/:slug/canchas/:id', organizerController.deleteCancha);
