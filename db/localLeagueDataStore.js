...
function ensureStore() {
  if (!fs.existsSync(STORE_PATH)) {
    fs.writeFileSync(
      STORE_PATH,
      JSON.stringify({ equipos: [], partidos: [], torneos: [], arbitros: [], canchas: [], representantes: [], inscripciones: [], multas: [] }, null, 2),
      'utf8'
    );
  }
}
...
function readStore() {
  ...
  return {
    ...
    canchas: Array.isArray(parsed.canchas) ? parsed.canchas : [],
    ...
    multas: Array.isArray(parsed.multas) ? parsed.multas : []
  };
}
